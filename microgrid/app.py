...
app = Flask(__name__)
app.secret_key = 'solar_savings_secret_key'
...
def calculate():
    try:
        ...
        return render_template('results.html', results=results, cost_per_kwh=COST_PER_KWH)
...
def export():
    try:
        ...
        # Write header
        writer.writerow(['ID', 'Monthly kWh', 'Panels Needed', 'Monthly Savings ($)', 
                        'Annual Savings ($)', 'Calculation Date'])
